...
async def choose_tariff_length(callback: CallbackQuery):
    ...
    price_map = {
        "month_basic_essay": LabeledPrice(label="Basic", amount=300_000),
        "month3_basic_essay": LabeledPrice(label="Basic", amount=765_000),
        "month_standart_essay": LabeledPrice(label="Standart", amount=350_000),
        "month3_standart_essay": LabeledPrice(label="Standart", amount=895_000),
        "month_premium_essay": LabeledPrice(label="Premium", amount=500_000),
        "month3_premium_essay": LabeledPrice(label="Premium", amount=1_250_000),
    }
    ...
    await bot.send_invoice(
        ...
        payload=f"{clean_tar}_{tariff}_{user_id}_ESSAY_3",
